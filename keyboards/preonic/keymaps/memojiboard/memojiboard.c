...
[_QWERTY] = LAYOUT_preonic_grid(
  KAP_DEAL_WITH_IT,     KAP_JOY,            KAP_MIND_BLOWN,     KAP_FACEMASK,       KC_NO,   KC_NO,   KC_NO,   KC_NO,   NEDRY,          NICE,       THIS,   BABY_YODA_HIDE,
  KAP_THUMB_UP,         KAP_CRYING,         KAP_APPROVES,       KAP_CELEBRATE,      KC_NO,   KC_NO,   KC_NO,   KC_NO,   GEORDI_NO,      THONK,      SAME,   JAZZ_CLUB,
  KAP_THUMB_DOWN,       KAP_WINKING,        KAP_DISAPPROVES,    KAP_ROLLING_EYES,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   GEORDI_YES,     NOTSUREIF,  YES,    DRIFTER_OOOH,
  KAP_FINGERS_CROSSED,  KAP_SWEAT_SMILE,    KAP_SURPRISED,      KAP_SANTA,          KC_NO,   KC_NO,   KC_NO,   KC_NO,   BEN_APPROVES,   CHEFSKISS,  NOPE,   ANDYDWYER,
  KAP_THINKING,         KAP_HEART_EYES,     KAP_SHUSH,          KC_NO,              LOWER,   _______, _______, RAISE,   KC_NO,          CHOPPYBOI,  PLS,    DISAPPEAR
),
